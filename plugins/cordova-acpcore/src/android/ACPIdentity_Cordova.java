...
public class ACPIdentity_Cordova extends CordovaPlugin {
		final static String METHOD_EXTENSION_VERSION_IDENTITY = "extensionVersionIdentity";
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        if ("extensionVersion".equals(action)) {
            this.extensionVersionIdentity(callbackContext);
            return true;
			}
		...
		// Identity Methods
		// ===============================================================
		private void extensionVersionIdentity(final CallbackContext callbackContext) {
